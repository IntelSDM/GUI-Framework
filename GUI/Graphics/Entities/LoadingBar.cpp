...
void LoadingBar::Draw()
{
	...
	{
		DrawText(LoadingBar::ParentPos.x + LoadingBar::Pos.x + (LoadingBar::Size.x / 2), LoadingBar::ParentPos.y + LoadingBar::Pos.y + 20 + (LoadingBar::Size.y), wprogress + LoadingBar::Name, Font, TextSize, textColour, Centre);
	}
	else
	{
