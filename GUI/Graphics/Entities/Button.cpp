...
void Button::Draw()
{
	...
	DrawText(ParentPos.x + Button::Pos.x + (Button::Size.x / 2), ParentPos.y + Button::Pos.y + (Button::Size.y / 2), GetTranslation(Button::Name), Font, TextSize, textColour, CentreCentre);
	DrawTooltip();
}
